...
function mount (env, server) {
  ...
  server.post('/api/v1/sites/registrations', noOp);
  // server.post('/api/v1/sites/:id', noOp);
  server.get('/api/v1/sites/:expected_name/assigned/permissions', noOp);
  server.post('/api/v1/sites/:expected_name/assigned/permissions', noOp);
  server.get('/api/v1/sites/:expected_name/assigned/groups', noOp);

  server.get('/api/v1/sites/:expected_name/available/tokens', noOp);
  server.get('/api/v1/sites/:expected_name/available/permissions', noOp);
  server.get('/api/v1/sites/:expected_name/available/groups', noOp);
  server.get('/api/v1/owner/:id/sites', noOp);
  server.get('/api/v1/owner/:id/groups', noOp);
