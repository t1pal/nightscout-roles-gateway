...
function mount (env, server) {
  ...
  **/
  ...
  /**
   * TODO: Hydra API
   *  // track consent to Nightscout in activity log
   *  // register site in Hydra
  **/
  ...
  **/
  ...
  server.get('/warden/v1/active/backend/for/:expected_name', policies.handlers.find_expected_name, policies.handlers.get_acls, policies( ), policies.handlers.deny_site_prefs, policies.handlers.matches_api_secret, policies.handlers.decision, policies.handlers.specify_upstream_handler, locals_results( ));
  server.head('/warden/v1/active/backend/for/:expected_name', policies.handlers.find_expected_name, policies.handlers.get_acls, policies( ), policies.handlers.deny_site_prefs, policies.handlers.matches_api_secret, policies.handlers.decision, policies.handlers.specify_upstream_handler, locals_results( ));
  ...
  server.get('/api/v1/privy/:identity/groups/joined', locals_results( ));
  server.get('/api/v1/privy/:identity/groups/joined/:group_id', noOp);
  server.del('/api/v1/privy/:identity/groups/joined/:group_id', noOp);
