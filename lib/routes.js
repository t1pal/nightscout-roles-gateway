...
function mount (env, server) {
  ...
  */
  ...
  server.get('/api/v1/owner/:owner_ref/sites/:expected_name/acl', noOp);
  server.get('/api/v1/owner/:owner_ref/sites/:expected_name/assigned/permissions', noOp);
  ...
  server.get('/api/v1/owner/:owner_ref/sites', noOp);
  server.get('/api/v1/owner/:owner_ref/sites/:expected_name', noOp);
  ...
  server.get('/api/v1/owner/:owner_ref/sites/:expected_name/available/groups', noOp);
  server.get('/api/v1/owner/:owner_ref/groups', noOp);
  server.get('/api/v1/owner/:owner_ref/groups/:id', noOp);
