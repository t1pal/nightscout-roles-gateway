...
function mount (env, server) {
  ...
  **/
  ...
  server.del('/api/v1/owner/:owner_ref/groups/:group_id/includes/:identity_type/:identity_spec', owner.handlers.get_group_details, locals_results( ));
  server.post('/api/v1/owner/:owner_ref/groups/:group_id/includes/:identity_type/:identity_spec', owner.handlers.get_group_details, locals_results( ));
